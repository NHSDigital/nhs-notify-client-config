...
export const $ClientSubscriptionBase = ConfigBase("ClientSubscription")
  .extend({
  ...
  .meta({
    ...
    description: `Base schema for client subscriptions, defining identifying fields.`,
  });

export const $ClientSubscription = $ClientSubscriptionBase
  .extend({
    ...
    callbackSecret: z
      .string()
      .meta({
        description: `Secret used to sign event payloads sent to the callbackUrl.
  ...
  .meta({
    ...
    description: `A client subscription indicates which events a client should be sent callbacks for.`,
  });
